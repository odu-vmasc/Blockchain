...
setGlobals () {
	...
	if [ $1 -eq 0 -o $1 -eq 1 -o $1 -eq 4 ] ; then
...
## Install chaincode on Peer4/Org1
#echo "Installing chaincode on org1/peer4..."
#installChaincode 4

#Query on chaincode on Peer4/Org1, check if the result is 90
echo "Querying chaincode on org1/peer4..."
chaincodeQuery 4 90
